...
const BorderSmugglingVisualization = () => {
  ...
  return (
    <div className="visualization-container">
      <h2 className="visualization-title" style={{ textAlign: 'center' }}>The cost of being smuggled into the U.S.</h2>
      <div 
      ...
      <div className="visualization-footer">
        <p>Using data from federal court documents,this visualization shows how much money migrants have said they pay to be smuggled into the U.S. from Mexico. Click on data points to see details about each of the {data.length} cases currently included.</p>
